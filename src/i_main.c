...
#if LIB_PICO_STDLIB && !JASZCZURHAL_PORT
...
#include "i_main.h"
#include "m_argv.h"
#if PICO_RP2350 && !JASZCZURHAL_PORT
...
int I_DoomMain(int argc, char **argv)
{
    // save arguments
#if !NO_USE_ARGS
    myargc = argc;
...
#endif
#endif
#if LIB_PICO_STDIO && !JASZCZURHAL_PORT
    stdio_init_all();
#endif
#if PICO_BUILD && !JASZCZURHAL_PORT
    I_Init();
#endif
#if USE_PICO_NET
